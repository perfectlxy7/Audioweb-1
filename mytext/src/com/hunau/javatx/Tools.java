...
public class Tools {
    ...
    public static void main(String[] args) throws Exception {
        // 打开串口
        SerialPort serialPort = portParameterOpen("COM4", 4800);
        // 要发送的数据
        String dataSend = "【我们是冠军，我们总是冠军，我们还是冠军，fpx牛逼！！！】";
        ...
        while(true) {
            ...
            if(dat != null && dat.length > 0) {
                ...
                System.out.println((i++) + ". 从串口接收的数据：当前温度为" + dataReceive);
            } else {
